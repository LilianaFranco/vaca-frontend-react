...
const GroupDetailPageContainer = lazy(() =>
  import("./pages/groups/GroupDetailPage.container")
);

const GroupsPageContainer = lazy(() =>
  import("src/pages/groups/GroupsPage.container")
);
